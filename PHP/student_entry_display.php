...
<body>
    ...
    <form  action="export.php" style="float:right;padding : auto;">
        <button class="back" ;>
            Export as Excel
        </button>
    </form>
    <form  action="search.php" method="POST" >
        <input type="text" name="sname" placeholder="Studentname"/>
        <button style="color:seashell;background-color: purple;">
            GO
        </button>
    </form>
     <center>
